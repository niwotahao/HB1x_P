...
{
    //++++++++++++++++++++++GT20L16S1Y CS口定义++++++++++++++++++//
    IO_FUNC_PORT_PIN(PORT1, CS1_PIN, IO_GIO);
    
    IO_DIR_PORT_PIN(PORT1, CS1_PIN, IO_OUT);
    //++++++++++++++++++++++LCD IO口定义++++++++++++++++++//
    IO_FUNC_PORT_PIN( PORT1, CS_PIN, IO_GIO );
    IO_FUNC_PORT_PIN( PORT0, DC_PIN, IO_GIO );
    IO_FUNC_PORT_PIN( PORT2, RES_PIN, IO_GIO);
	IO_FUNC_PORT_PIN( PORT0, LIGHT_PIN, IO_GIO);

    IO_DIR_PORT_PIN(PORT1, CS_PIN, IO_OUT);
    IO_DIR_PORT_PIN(PORT0, DC_PIN, IO_OUT);
    IO_DIR_PORT_PIN(PORT2, RES_PIN, IO_OUT);
	IO_DIR_PORT_PIN(PORT0, LIGHT_PIN, IO_OUT);
    //++++++++++++++++++++++MRF522 IO口定义++++++++++++++++++//
    IO_FUNC_PORT_PIN(PORT1,MF522_NSS_PIN, IO_GIO );
    IO_FUNC_PORT_PIN(PORT2,MF522_RST_PIN, IO_GIO );
    
    IO_DIR_PORT_PIN(PORT1,MF522_NSS_PIN, IO_OUT);
    IO_DIR_PORT_PIN(PORT2,MF522_RST_PIN, IO_OUT);
    //++++++++++++++++++++++MOTOR IO口定义++++++++++++++++++//
...
{
    /***************Key Interrupt Init****************/
    IO_FUNC_PORT_PIN(0,1, IO_GIO ); /**<  按键1 I/O功能 */
    IO_FUNC_PORT_PIN(0,2, IO_GIO ); /**<  按键2 I/O功能 */
    IO_FUNC_PORT_PIN(0,3, IO_GIO ); /**<  按键3 I/O功能 */
    IO_FUNC_PORT_PIN(0,4, IO_GIO ); /**<  RC522IRQ I/O功能 */
    IO_FUNC_PORT_PIN(0,6, IO_GIO ); /**<  充电指示 I/O功能 */
    ...
    IO_IMODE_PORT_PIN(0,4,IO_PUD);
    IO_IMODE_PORT_PIN(0,6,IO_PUD);
    
    IO_PUD_PORT(0,IO_PUP);

    IO_FUNC_PORT_PIN(0,5,IO_PER);   /**< 外设备功能 */
    ...
    //P0IEN |= 0x4F;  /**< 0100 1110 P0.12346 Enable interrupt Mask */
