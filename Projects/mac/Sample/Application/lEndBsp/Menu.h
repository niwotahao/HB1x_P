...
//extern void MENU_ShowBatt( uint8 j);
extern void MENU_ShowShuZi(uint8 data, uint8 shuzipage, uint8 shuzifont,uint8 of,uint16 fcolor,uint16 bcolor);
extern void MENU_ShowString(uint8 * data, uint8 datalen, uint8 page,uint8 font,uint8 of,uint16 fcolor,uint16 bcolor);
extern void MENU_ClearScreen(uint8 xs, uint8 ys, uint8 xe, uint8 ye); 
