...
void BSP_InitInterrupt(void)
{
    ...
    P0IEN |= 0x03; //P0.01 Enable interrupt Mask
...
#define K_LED1_PIN 4   //P0.4
#define K_LED2_PIN 5   //P0.5
    
#define M_LED3_PIN 7   //P1.7
#define M_LED4_PIN 0   //P2.0


    IO_FUNC_PORT_PIN( PORT0,K_LED1_PIN, IO_GIO);
    IO_DIR_PORT_PIN(PORT0,K_LED1_PIN,IO_OUT);

    IO_FUNC_PORT_PIN( PORT0,K_LED2_PIN, IO_GIO);
    IO_DIR_PORT_PIN(PORT0,K_LED2_PIN,IO_OUT);

    IO_FUNC_PORT_PIN( PORT1,M_LED3_PIN, IO_GIO);
    IO_DIR_PORT_PIN(PORT1,M_LED3_PIN,IO_OUT);

    IO_FUNC_PORT_PIN( PORT2,M_LED4_PIN, IO_GIO);
    IO_DIR_PORT_PIN(PORT2,M_LED4_PIN,IO_OUT);
...
uint16 MSA_ProcessEvent(uint8 taskId, uint16 events)
{
    ...
    if(events&MSA_DIS_KEY_EVENT)
    {
        ...
        P0IEN &= ~0x03;                 //P0.01 DisEnable interrupt Mask
