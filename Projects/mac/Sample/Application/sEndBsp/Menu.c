...
********************************************************************************************************/
const __code uint8 TX_POWER[] = //功率线
{
    ...
    0x00,0x50,0x20,0x50,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00  //7 x接收
    //0x88,0x50,0x20,0x50,0x88,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
    
    //0x00,0x44,0x28,0x10,0x28,0x44,  //7 x接收
    //0x00,0x00,0x00,0x00,0x00,0x00
};
/********************************************************************************************************
...
void  MENU_DisLowPower(void)
{
    ...
    p = "电量低,请充电";
	MENU_ShowString(p,13,1,12,0); 				            /**< 显示电池电量低 */
