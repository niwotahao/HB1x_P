...
/***************Key Interrupt Init****************/
    ...
    P1.2
    */
#define KEY0_PIN 5      //P0.3
#define KEY1_PIN 4      //P0.4
#define KEY2_PIN 5      //P0.5
#define KEY3_PIN 1      //P0.1
#define KEY4_PIN 2      //P0.2
...
uint16 MSA_ProcessEvent(uint8 taskId, uint16 events)
{
    ...
    if(events&MSA_READ_KEY_EVT)
    {
        ...
        if(ReadFlg == 0x01)
        {
            ...
            /*****************************************************/
            P1_2 = 1;
            osal_start_timerEx(MSA_TaskId,MSA_KEY_DELAY_EVT,300);
            /*****************************************************/
        }
        else
        {
