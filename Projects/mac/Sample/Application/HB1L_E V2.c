...
#define MSA_READ_KEY_EVT        0x1000
#define MSA_STOP_KEY_EVT        0x2000
...
void BSP_InitInterrupt(void)
{
    ...
    P0IEN |= 0x3F; //P0.012345 Enable interrupt Mask
...
#define BEEP_PIN 0          //P1.0
#define LED_PIN 5           //P1.5
#define RFID_LED_PIN 0       //P2.0
    ...
    IO_FUNC_PORT_PIN(PORT2,RFID_LED_PIN,IO_GIO);
    IO_DIR_PORT_PIN(PORT2,RFID_LED_PIN,IO_OUT);
...
uint16 MSA_ProcessEvent(uint8 taskId, uint16 events)
{
    ...
    if(events&MSA_LED_EVENT)
    {
        ...
        else if((KeyValue <= 0x00000006)&&(KeyValue >= 0x00000001))	    /**< 01~07 */ 
        {
            LedCnt = 0x02;
        }
    ...
    if(events&MSA_DIS_KEY_EVENT)
    {
        ...
        P0IEN &= ~0x3F;                 //P0.012345 DisEnable interrupt Mask
