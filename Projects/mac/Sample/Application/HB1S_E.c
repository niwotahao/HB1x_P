...
#if defined(HB1x_E_TX_ZC)
    /***************Key Interrupt Init****************/
    //APCFG |= 0x20;//P0.5ADC
    PICTL |= 0x01;  //Falling edge
    P0IEN |= 0x06; //P0.12 Enable interrupt Mask
...
#define LED1_PIN 6   //P1.6
#define LED2_PIN 5   //P1.5
#define LED3_PIN 3   //P1.3
#define LED4_PIN 2   //P1.2
#define LED5_PIN 0   //P1.0
#define LED6_PIN 6   //P0.6
#define LED7_PIN 5   //P0.5
    ...
    IO_FUNC_PORT_PIN( PORT1,LED5_PIN, IO_GIO);
    IO_DIR_PORT_PIN(PORT1,LED5_PIN,IO_OUT);

    IO_FUNC_PORT_PIN( PORT0,LED6_PIN, IO_GIO);
    IO_DIR_PORT_PIN(PORT0,LED6_PIN,IO_OUT);

    IO_FUNC_PORT_PIN( PORT0,LED7_PIN, IO_GIO);
    IO_DIR_PORT_PIN(PORT0,LED7_PIN,IO_OUT);
    ...
    //APCFG |= 0x20;//P0.5ADC
    PICTL |= 0x01;  //Falling edge
    P0IEN |= 0x30; //P0.45 Enable interrupt Mask
    IEN1 |= 0x20;  //BV(5)P0 Interrupt enable
    P0IFG = 0x00; //Clear any pending interrupt
    ...
    P0.1
    */
#define KEY1_PIN 4   //P0.4
#define KEY2_PIN 5   //0.5
    IO_FUNC_PORT_PIN( PORT0,KEY1_PIN, IO_GIO);
    IO_DIR_PORT_PIN(PORT0,KEY1_PIN,IO_IN);
    IO_IMODE_PORT_PIN(PORT0,KEY1_PIN,IO_PUP);
...
#define LED1_PIN 2   //P1.2
#define LED2_PIN 3   //P1.3
#define LED3_PIN 6   //P1.6
#define LED4_PIN 7   //P1.7
#define LED5_PIN 0   //P2.0
#define LED6_PIN 0   //P0.0
#define LED7_PIN 1   //P0.1
...
#else
#define KEY2_INTERRUPT_FLAG_MASK        0x10//P0.4
...
uint16 MSA_ProcessEvent(uint8 taskId, uint16 events)
{
    ...
    if(events&MSA_LED_EVENT)
    {
		...
		else if(KeyValue == 0x00000002)		/**< 取消按键标示 */
		{
            LedCnt = 0x05;
		}
        ...
        else if(KeyValue == 0x80000002)     /**< 广播取消 */
        {
            LedCnt = 0x06;
        }
        else
    ...
    if(events&MSA_DIS_KEY_EVENT)
    {
        ...
        asm("NOP");
    #if defined(HB1x_E_TX_ZC)
        P0IEN &= ~0x06;                 //P0.12 DisEnable interrupt Mask
    #else
        P0IEN &= ~0x30;                 //P0.45 DisEnable interrupt Mask
    #endif
        asm("NOP");
        P2INP |= 0x20;
        asm("NOP");
