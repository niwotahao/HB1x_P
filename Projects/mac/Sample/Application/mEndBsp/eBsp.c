...
{
    //++++++++++++++++++++++GT21L16S2W IO口定义++++++++++++++++++//
    //IO_FUNC_PORT_PIN( PORT0, CS1_PIN, IO_GIO);  //开机不灵敏问题把按键P0_3和字库的CS脚P1_3混合
    IO_FUNC_PORT_PIN( PORT2, CS1_PIN, IO_GIO);
    IO_FUNC_PORT_PIN( PORT1, CLK_PIN, IO_GIO);
    IO_FUNC_PORT_PIN( PORT1, SI_PIN, IO_GIO);
    IO_FUNC_PORT_PIN( PORT1, SO_PIN, IO_GIO);

    //IO_DIR_PORT_PIN(PORT0, CS1_PIN, IO_OUT); //开机不灵敏问题把按键P0_3和字库的CS脚P1_3混合
    IO_DIR_PORT_PIN(PORT2, CS1_PIN, IO_OUT);
...
//++++++++++++++++++++++OLED IO口定义++++++++++++++++++//
    ...
    IO_FUNC_PORT_PIN( PORT1, SCLK_PIN, IO_PER);
	IO_FUNC_PORT_PIN( PORT1, SDIN_PIN, IO_PER);
