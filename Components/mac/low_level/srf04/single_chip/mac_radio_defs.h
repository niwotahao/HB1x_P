...
#define CCA_THR_HGM                   0x10//-60dbm//0x06   /* 6-76=-70dBm when CC2530 operated with CC2591 in HGM */
...
#define MAC_RADIO_SET_CHANNEL(x)                      st( FREQCTRL = FREQ_2475MHZ + 5 * ((x) - 11); )
